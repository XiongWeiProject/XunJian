...
public class MovieRecorderView extends LinearLayout implements OnErrorListener {
	...
	public MovieRecorderView(Context context, AttributeSet attrs, int defStyle) {
		...
		TypedArray a = context.obtainStyledAttributes(attrs,
				AlertUtils.MovieRecorderView, defStyle, 0);
		mWidth = a.getInteger(AlertUtils.MovieRecorderView_width, 320);// 默认320
		mHeight = a.getInteger(AlertUtils.MovieRecorderView_height, 240);// 默认240

		isOpenCamera = a.getBoolean(
				AlertUtils.MovieRecorderView_is_open_camera, true);// 默认打开
		mRecordMaxTime = a.getInteger(
				AlertUtils.MovieRecorderView_record_max_time, 10);// 默认为10
